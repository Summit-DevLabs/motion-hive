  ...
  return (
    <div className="relative bg-primary">
      ...
      <Container className="relative pb-16 pt-20 text-center lg:pt-32">
        <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight sm:text-7xl metallic-red">
          We create badass{" "}
          <span className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight sm:text-7xl metallic-blue">
            VFX
          </span>{" "}
          and{" "}
          <span className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight sm:text-7xl metallic-green">
            Holograms
          </span>
        </h1>
